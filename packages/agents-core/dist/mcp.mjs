 ...
 */
export async function getAllMcpFunctionTools(mcpServers, runContext, agent, convertSchemasToStrict = false) {
    const allTools = [];
    const toolNames = new Set();
    for (const server of mcpServers) {
        const serverTools = await getFunctionToolsFromServer(server, runContext, agent, convertSchemasToStrict);
 ...
 */
async function getFunctionToolsFromServer(server, runContext, agent, convertSchemasToStrict) {
 ...
 */
export async function getAllMcpTools(mcpServers, runContext, agent, convertSchemasToStrict = false) {
    return getAllMcpFunctionTools(mcpServers, runContext, agent, convertSchemasToStrict);
}
/**
