...
export declare class RunInjectedMessageItem extends RunItemBase {
    rawItem: protocol.MessageItem;
    agent: Agent;
    readonly type: "injected_message_item";
    constructor(rawItem: protocol.MessageItem, agent: Agent);
    toJSON(): {
        agent: {
            name: string;
        };
...
export type RunItem = RunMessageOutputItem | RunToolCallItem | RunReasoningItem | RunHandoffCallItem | RunToolCallOutputItem | RunHandoffOutputItem | RunToolApprovalItem | RunInjectedMessageItem;
/**
