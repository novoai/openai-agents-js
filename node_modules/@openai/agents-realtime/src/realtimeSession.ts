...
import type {
    ...
    RealtimeUserInput,
} from '@openai/agents-realtime/src/clientMessages';
import {
...
} from '@openai/agents-realtime/src/guardrail';
import { RealtimeItem } from '@openai/agents-realtime/src/items';
import { OpenAIRealtimeModels } from '@openai/agents-realtime/src/openaiRealtimeBase';
import { OpenAIRealtimeWebRTC } from '@openai/agents-realtime/src/openaiRealtimeWebRtc';
import { OpenAIRealtimeWebSocket } from '@openai/agents-realtime/src/openaiRealtimeWebsocket';
import { RealtimeAgent } from '@openai/agents-realtime/src/realtimeAgent';
import { RealtimeSessionEventTypes } from '@openai/agents-realtime/src/realtimeSessionEvents';
import type { ApiKey, RealtimeTransportLayer } from '@openai/agents-realtime/src/transportLayer';
import type { TransportToolCallEvent } from '@openai/agents-realtime/src/transportLayerEvents';
import type { InputAudioTranscriptionCompletedEvent } from '@openai/agents-realtime/src/transportLayerEvents';
import {
    getLastTextFromAudioOutputMessage,
    hasWebRTCSupport,
    updateRealtimeHistory,
} from '@openai/agents-realtime/src/utils';
import logger from '@openai/agents-realtime/src/logger';
