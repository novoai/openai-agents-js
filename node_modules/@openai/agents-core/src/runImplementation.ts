import { FunctionCallResultItem } from '@openai/agents-core/src/types/protocol';
import { Agent, AgentOutputType, ToolsToFinalOutputResult } from '@openai/agents-core/src/agent';
import { ModelBehaviorError, ToolCallError, UserError } from '@openai/agents-core/src/errors';
import { getTransferMessage, Handoff, HandoffInputData } from '@openai/agents-core/src/handoff';
import {
    RunHandoffCallItem,
...
} from '@openai/agents-core/src/items';
import logger, { Logger } from '@openai/agents-core/src/logger';
import { ModelResponse, ModelSettings } from '@openai/agents-core/src/model';
import {
    ComputerTool,
    FunctionTool,
    Tool,
    FunctionToolResult,
    HostedMCPTool,
} from '@openai/agents-core/src/tool';
import { AgentInputItem, UnknownContext } from '@openai/agents-core/src/types';
import { Runner } from '@openai/agents-core/src/run';
import { RunContext } from '@openai/agents-core/src/runContext';
import { getLastTextFromOutputMessage } from '@openai/agents-core/src/utils/messages';
import { withFunctionSpan, withHandoffSpan } from '@openai/agents-core/src/tracing/createSpans';
import { getSchemaAndParserFromInputType } from '@openai/agents-core/src/utils/tools';
import { safeExecute } from '@openai/agents-core/src/utils/safeExecute';
import { addErrorToCurrentSpan } from '@openai/agents-core/src/tracing/context';
import { RunItemStreamEvent, RunItemStreamEventName } from '@openai/agents-core/src/events';
import { StreamedRunResult } from '@openai/agents-core/src/result';
import { z } from '@openai/zod/v3';
import { toSmartString } from '@openai/agents-core/src/utils/smartString';
import * as protocol from '@openai/agents-core/src/types/protocol';
import { Computer } from '@openai/agents-core/src/computer';
import { RunState } from '@openai/agents-core/src/runState';
import { isZodObject } from '@openai/agents-core/src/utils';
import * as ProviderData from '@openai/agents-core/src/types/providerData';
