...
import logger from '@openai/agents-openai/src/logger';
import { HEADERS } from '@openai/agents-openai/src/defaults';
...
import { convertChatCompletionsStreamToResponses } from '@openai/agents-openai/src/openaiChatCompletionsStreaming';
import {
    convertToolChoice,
    toolToOpenAI,
    convertHandoffTool,
    itemsToMessages,
} from '@openai/agents-openai/src/openaiChatCompletionsConverter';
